...
<body class="fondoV">
      ...
      <nav id="menuprincipal">     
        <div> 
            ...
            <body>
            <form action="../php/Control_tipo.php" method="post">
                    <section class="form-registerP">
                        <h4>Agregar tipo de auto</h4><br>
                        <div id="columna1">
                            <br>
                            <br>          
                            <input type="hidden" nombre="opcion" value="1">
                            ID
                            <input name="id_tipo" class="controlsP" type="text" placeholder="ID" required>
                            Tipo de auto
                            <input name="nombre_tipo" class="controlsP" type="text" placeholder="Tipo">
                            <input class="botonsP" name="btnRegistrar" id="boton" type="submit" value="Registrar">
                        </div>    
                       </div>
                    </section> 
                    </form>
