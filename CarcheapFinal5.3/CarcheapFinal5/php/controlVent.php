                        ...
                        <div id="columna3">
                            ...
                            if(isset($_REQUEST['opcion'])){
                                ...
                                switch($opcion){
                                    ...
                                    case 1:
                                        $usu -> inicializar( $_REQUEST['id_vehiculo'], $_REQUEST['id_usuario']);
                                        $usu -> insertar();
                                        break;
                                    case 2:
                                        $usu -> modificar($_REQUEST['id_vehiculo']);
                                        break;
                                    case 3:
                                        $usu -> modificar2($_REQUEST['id_vehiculo'], $_REQUEST['id_vehiculoN'], $_REQUEST['id_usuario']);
                                        break;
                                    case 4:
                                        $usu ->eliminar($_REQUEST['id_vehiculo']);
                                        break;
                                    case 5:
                                        $usu ->consultar($_REQUEST['id_vehiculo']);
                                        break;
                                    case 6:
                                        $usu ->tabla();
                                        break;
