...
<body class="fondoV">
      ...
      <nav id="menuprincipal">     
        <div> 
            ...
            <main>
                <div>
                    <form action="../../php/ControlSubmarca.php" method="post"></form>
                    <section class="form-registerP">
                        <h4>Modificar submarca</h4><br>
                        <div id="columna1">
                            <br>
                            <br>
                            <input type="hidden" name="opcion" value="4">
                            ID
                            <input class="controlsP" name="id_submarca" type="text" placeholder="ID"onlyread>
                            Submarca
                            <input class="controlsP" name="nombre_submarca" type="text" placeholder="Submarca">
                            <br>
                            ...
                            <input class="botonsP" id="boton" type="submit" value="Modificar">
                        </div>
                    </section> 
                    </form>
                </div>
